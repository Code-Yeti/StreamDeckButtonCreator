...
![version](https://img.shields.io/badge/version-4.7.0-e94560)
...
aspect ratio (on by default), and every layer except marching ants can be
resized with a scale slider that works from the layer's centre.
